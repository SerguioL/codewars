...
function jumpTo(x, y, moves =0) {
    ...
    if (y === x) {
        ...
        return jumpTo(x, y / 2, moves + 1);
    }
    return jumpTo(x, y - 1, moves + 1);

}

console.log(jumpTo(1, 8)); //3, 'jumpTo(1, 8)'
console.log(jumpTo(1, 17)); //5, 'jumpTo(1, 17)'
console.log(jumpTo(1, 15)); //6, 'jumpTo(1, 15)'
console.log(jumpTo(3, 12)); //2, 'jumpTo(3, 12)'
console.log(jumpTo(3, 16)); //3, 'jumpTo(3, 16)'
console.log(jumpTo(3, 17)); //4, 'jumpTo(3, 17)'
console.log(jumpTo(10, 19));//9, 'jumpTo(10, 19)'
